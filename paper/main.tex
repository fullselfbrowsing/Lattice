...
\title{Lattice: Capability Receipts for Verifiable and\\ Reproducible Multimodal Model Orchestration}

\author{\IEEEauthorblockN{Venkat Lakshman Turlapati}
\IEEEauthorblockA{Full Self Browsing\\
Preferred name: Lakshman Turlapati\\
