...
| v1.4 Provider Breadth + Live Multimodal + Observability Export | Planning | — | requirements + roadmap pending (`/gsd-new-milestone`) |
...
### v1.4 Provider Breadth + Live Multimodal + Observability Export (planning)
