...
- [x] 07-02-PLAN.md — Pre-flight evaluator + router integration with contract reject codes (Wave 2)
- [x] 07-03-PLAN.md — Adapter usage normalization + RunResult.usage + NoContractMatchError (Wave 2)
- [x] 07-04-PLAN.md — Runtime wiring through ai.run, classification, and public exports (Wave 3)
...
**Plans**: 4 plans
Plans:
- [x] 09-01-PLAN.md — Receipt types, RFC 8785 canonicalize wrapper, redactor, KeySet (Wave 1)
- [x] 09-02-PLAN.md — DSSE envelope + WebCrypto Ed25519 signer + @noble parity oracle (Wave 1)
- [x] 09-03-PLAN.md — createReceipt redact-then-sign pipeline + pure verifyReceipt (Wave 2)
- [x] 09-04-PLAN.md — Runtime wiring (signer, terminal-branch receipts) + public surface (Wave 3)
...
Plans:
- [x] 13.1-01-PLAN.md — Sidecar loader + walker pairing + types (Wave 1)
- [x] 13.1-02-PLAN.md — CLI wiring: repro + eval flags and handler updates (Wave 2)
- [x] 13.1-03-PLAN.md — Showcase sidecar writes + showcase-e2e flips + 13-02-SUMMARY annotations (Wave 3)
