...
export const COMMENT_RULES = Object.freeze([
  ...
  Object.freeze({
    ...
    pattern: new RegExp(
      `\\b(?:T|${TICKET_PREFIXES.join("|")})-(?:[A-Z0-9]+-)*\\d+\\b`,
      "u",
    ),
  }),
  Object.freeze({
    id: "CH006_WORKFLOW_NARRATION",
    pattern: /\b(?:this PR|this change|introduced by|deferred to (?:a )?(?:phase|plan)|future follow-up|review (?:finding|note)|audit note|validation gate|sweep gate|Nyquist|D-lock)\b/iu,
  }),
  Object.freeze({
    id: "CH007_TASK_STATE",
