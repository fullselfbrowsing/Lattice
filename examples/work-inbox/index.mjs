...
process.stdout.write(
  `  pnpm --filter @full-self-browsing/lattice-cli exec lattice verify ${successReceiptPathRel} --key ${keysetPathRel}\n`,
);
process.stdout.write(
  `  pnpm --filter @full-self-browsing/lattice-cli exec lattice repro ${qualityFloorReceiptPathRel} --key ${keysetPathRel} --fixtures ${fixturesDirRel} --sidecar-dir ${sidecarsDirRel}\n`,
);
process.stdout.write(
  `  pnpm --filter @full-self-browsing/lattice-cli exec lattice eval --fixtures ${receiptsDirRel} --key ${keysetPathRel} --artifacts ${fixturesDirRel} --sidecar-dir ${sidecarsDirRel} --baseline ${relPath(ctx.baselinePath)} --init-baseline\n`,
);
